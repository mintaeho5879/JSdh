...
const submit = async () => {
    ...
    if (state.form.payment === 'bank') {
        ...
        message.push(`농협 247-02-350111 계좌로 ${price}원을 입금해주시기 바랍니다.`);
    }
    alert(message.join('\n'));
    await router.push('/');
}
        ...
        <div class="row g-5">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <div class="pt-1" v-if="state.form.payment === 'card'">
                    ...
                    <input type="text" class="form-control p-3" id="cardNum" v-model="state.form.cardNumber" placeholder="16자리 숫자로 입력해주세요." maxlength="16">
                </div>
            </div>
        </div>
    </div>
